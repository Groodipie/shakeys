<div class="container-fluid px-3 px-md-4 py-4" style="max-width:1100px;margin:0 auto;">
  ...
  <div class="bg-white rounded-4 p-5 text-center shadow-sm" style="max-width:480px;margin:0 auto;">
    ...
    <a href="<?= e(url('/menu')) ?>" class="btn fw-bold px-4 py-2" style="background:var(--sk-red);color:#fff;border-radius:8px;">Browse Menu</a>
  </div>
  ...
  <div class="row g-4">
        ...
        <div class="bg-white rounded-4 overflow-hidden shadow-sm">
          ...
          <div class="d-flex align-items-center gap-3 p-3 border-bottom">
            ...
            <div class="text-end" style="min-width:90px;">
              ...
              <?php if (!empty($item['crust']) || !empty($item['size'])): ?>
                <a href="<?= e(url('/product/' . (int)$item['prod_id'] . '?edit=' . urlencode($key))) ?>" class="text-secondary d-block" style="font-size:.75rem;text-decoration:none;">
                  <i class="bi bi-pencil"></i> Edit
                </a>
              <?php endif; ?>
              <a href="<?= e(url('/cart?remove=' . urlencode($key))) ?>" class="text-danger" style="font-size:.75rem;text-decoration:none;">
          ...
          <div class="p-3 d-flex gap-2 justify-content-between">
            <a href="<?= e(url('/menu')) ?>" class="btn btn-sm" style="border:1px solid var(--sk-red);color:var(--sk-red);">
    ...
    <div class="col-lg-4">
      <div class="bg-white rounded-4 p-4 shadow-sm">
        ...
        <a href="<?= e(url('/checkout')) ?>" class="btn fw-bold w-100 py-2" style="background:var(--sk-red);color:#fff;border-radius:8px;">
          Proceed to Checkout <i class="bi bi-arrow-right ms-1"></i>
        </a>
        <a href="<?= e(url('/menu')) ?>" class="btn btn-outline-secondary w-100 mt-2 py-2">Continue Shopping</a>
      </div>
    </div>
  </div>
  <?php endif; ?>
